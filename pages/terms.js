  ...
  return (
      <div>
        ...
        <section className={style(styles.row)}>
          ...
          <p className={style(styles.text)}>3.7. [Company reserves the right to use your name and/or company name as a reference for marketing or promotional purposes on Company's website and in other communication with existing or potential Company customers. To decline Company this right you need to email support@zeit.co stating that you do not wish to be used as a reference.</p>
          ...
          <p className={style(styles.text)}>You have the right to terminate your account at any time by sending a cancellation request to support@zeit.co. Subject to earlier termination as provided below, Company may terminate your Account and this TOS at any time by providing thirty (30) days prior notice to the administrative email address associated with your Account. All of Your Content on the Service (if any) may be permanently deleted by Company upon any termination of your account in its sole discretion.</p>
