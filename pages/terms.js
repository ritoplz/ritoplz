  ...
  return (
      <div>
        ...
        <section className={style(styles.row)}>
          ...
          <p className={style(styles.text)}>3.7. Company reserves the right to use your name and/or company name as a reference for marketing or promotional purposes on Company's website and in other communication with existing or potential Company customers. To decline Company this right you need to email ritoplzteam@gmail.com stating that you do not wish to be used as a reference.</p>
